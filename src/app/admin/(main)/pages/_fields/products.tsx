    ...
    <div className="space-y-12">
      <div className="space-y-5">
        ...
        <FieldRow label="筛选区标题">
          <TextInput name="filter.sidebarTitle" defaultValue={zh ? "筛选器" : "Filters"} />
        </FieldRow>
        <div className="grid grid-cols-3 gap-4">
          <FieldRow label="厂牌分组标题">
            <TextInput name="filter.brandTitle" defaultValue={zh ? "品牌" : "Brands"} />
          </FieldRow>
          <FieldRow label="类目分组标题">
            <TextInput name="filter.categoryTitle" defaultValue={zh ? "分类" : "Categories"} />
          </FieldRow>
          <FieldRow label="年份分组标题">
            <TextInput name="filter.yearTitle" defaultValue={zh ? "年份" : "Year"} />
          </FieldRow>
        </div>
