    ...
    <main className="w-full flex-1">
      ...
      <section className="relative w-full h-screen min-h-[800px] flex items-center justify-center overflow-hidden bg-[#111111]">
        ...
        <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 sm:px-8 flex flex-col items-center text-center pt-20">
          <div className="inline-flex items-center gap-3 px-5 py-2.5 border border-white/20 backdrop-blur-md mb-8">
             ...
             <span className="text-white text-xs font-bold uppercase tracking-[0.2em]">面向国际市场的高端二手工程机械</span>
          </div>

          <h1 className="text-[10vw] sm:text-[8vw] md:text-7xl lg:text-[7vw] xl:text-[110px] font-black tracking-tight text-white leading-tight uppercase drop-shadow-2xl whitespace-nowrap w-full">
            铸塑未来的 <span className="text-transparent bg-clip-text bg-gradient-to-b from-[#D4AF37] via-[#F3E5AB] to-[#8C7322] drop-shadow-2xl px-2">重工力量</span>
          </h1>
          <div className="mt-16 flex flex-col sm:flex-row items-center justify-center gap-6 animate-fade-in-up" style={{animationDelay: '0.4s'}}>
             <a href="#categories" className="w-full sm:w-[230px] h-[56px] border border-transparent bg-[#D4AF37] text-white text-[14px] font-bold tracking-widest uppercase hover:bg-white hover:text-[#111111] transition-all duration-300 shadow-xl flex items-center justify-center gap-3 group">
               探索核心机械
               <ArrowRight size={18} className="rotate-90 sm:rotate-0 group-hover:translate-x-1 transition-transform" />
             </a>
             <button 
                onClick={toggleHeroVideo} 
                className={`w-full sm:w-[230px] h-[56px] border border-white/30 text-[14px] font-bold tracking-widest uppercase transition-all duration-500 backdrop-blur-md flex items-center justify-center gap-3 group shadow-xl ${isPlayingVideo ? 'bg-white text-[#111111]' : 'bg-black/40 text-white hover:bg-white hover:text-[#111111]'}`}
             >
               {isPlayingVideo ? (
                 <>
        ...
        <div className="max-w-[1440px] mx-auto px-8">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-12 gap-8">
            <div className="flex flex-col shrink-0">
              <h2 className="text-5xl md:text-6xl font-black tracking-tighter text-[#111111] uppercase">全矩阵设备覆盖</h2>
            </div>
            <div className="max-w-xl border-l-4 border-[#D4AF37] pl-6 hidden lg:block">
              <p className="text-gray-500 text-sm leading-relaxed font-medium">无论您的工程面临何种极端挑战，我们都能为您提供从强力挖掘、重型装载到路面打造的全场景、无死角的高端重装解决方案。</p>
            </div>
          </div>
        </div>
      ...
      <section className="w-full py-32 bg-[#FAFAFA] border-t border-gray-100">
        <div className="max-w-[1440px] mx-auto px-8">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 gap-8">
            <div className="flex flex-col shrink-0">
              <h2 className="text-5xl md:text-6xl font-black tracking-tighter text-[#111111] uppercase">严选热销机皇</h2>
            </div>
            <div className="max-w-xl border-l-4 border-[#D4AF37] pl-6 hidden lg:block">
              <p className="text-gray-500 text-sm leading-relaxed font-medium">这些顶级现货机型经过 100 项全案严苛过滤，代表着本月极低的故障率和极高的投资回报比，是全球大型基建的首选制胜装备。</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {[
              ...
              <a href="#product-detail" key={index} className="group bg-white flex flex-col cursor-pointer border border-gray-100 hover:shadow-2xl transition-all duration-500 rounded-sm overflow-hidden pb-8">
                <div className="relative w-full aspect-[4/3] bg-[#EFEFEF] overflow-hidden">
                  <Image src={item.bgImg} alt={item.title} fill className="object-cover md:object-contain group-hover:scale-110 transition-transform duration-700 ease-in-out p-6" />
          ...
          <div className="mt-16 text-center">
            <button className="text-sm font-bold uppercase tracking-[0.2em] text-[#111111] border-b-2 border-transparent hover:border-[#111111] transition-colors inline-flex items-center gap-2">
              游览所有 300+ 在线设备 <ArrowRight size={16} />
            </button>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="p-14 md:p-20 lg:p-24 flex flex-col justify-center relative z-10 border-r border-white/10">
            ...
            <p className="text-gray-400 leading-relaxed max-w-sm mb-12 text-sm">
              KXTJ 不仅仅是一家贸易商。我们在全球拥有自建的大型存放仓储与检测翻新基地。所有出海设备均由原厂级资深工程师亲手拆解、保养与极端测试，拒绝铁疙瘩，只发真战力。
            </p>
            
            {/* 合并：紧凑化的高能数据组 */}
            <div className="grid grid-cols-2 gap-x-6 gap-y-10">
               <div>
                  <h4 className="text-3xl lg:text-4xl font-black mb-1 text-white"><NumberTicker value={1200} /><span className="text-[#D4AF37]">+</span></h4>
                  <p className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">全球成功交付设备</p>
               </div>
               <div>
                  <h4 className="text-3xl lg:text-4xl font-black mb-1 text-white"><NumberTicker value={50} /><span className="text-[#D4AF37]">+</span></h4>
                  <p className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">无缝海运覆盖国家</p>
               </div>
               <div>
                  <h4 className="text-3xl lg:text-4xl font-black mb-1 text-white"><NumberTicker value={2000} /><span className="text-[#D4AF37]">+</span></h4>
                  <p className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">平米超级仓储展区</p>
               </div>
               <div>
                  <h4 className="text-3xl lg:text-4xl font-black mb-1 text-white"><NumberTicker value={100} /><span className="text-[#D4AF37]">%</span></h4>
                  <p className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">全节点拆机复检率</p>
               </div>
            </div>
          </div>
          ...
          <div className="relative min-h-[400px] lg:min-h-full flex items-center justify-center group overflow-hidden bg-black">
            {isFactoryVideoPlaying ? (
              ...
              <>
                 ...
                 <span className="absolute bottom-10 z-20 text-white/70 text-[10px] font-bold tracking-[0.3em] uppercase">点击直接浏览实境影像</span>
              </>
            )}
          </div>
        </div>
      ...
      <section className="w-full py-32 bg-white">
        <div className="max-w-[1440px] mx-auto px-8">
          <div className="text-center mb-24">
            <h2 className="text-5xl font-black tracking-tighter text-[#111111] uppercase mb-4">世界级的交付与服务标准</h2>
            <p className="text-gray-500 max-w-2xl mx-auto">在跨国重装采购中，物流与售后往往是最大的阻碍。我们将为您彻底铲除这些摩擦力，提供真正的端到端出海服务体系。</p>
          </div>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            {[
              { icon: ShieldCheck, title: "100项隐患全排查", desc: "从发动机、液压主泵到外观履带，严格执行原厂级全案检测体系，出具全流程权威视频报告。" },
              { icon: Factory, title: "全自管翻新与喷漆", desc: "我们在国内拥有一流的数控机床与原厂喷漆房阵列，支持机器的动力总成大修与原厂化翻新装配。" },
              { icon: Wrench, title: "原厂级易损件直供", desc: "为海外发盘一次性备齐各类核心易损件打包（如滤芯、皮带、销轴），大幅延长基建区作业生命。" },
              { icon: Settings, title: "工况重度改装调校", desc: "针对非洲极端高温和南美高湿度恶劣矿区，针对性地加强液压散热管线和冷媒，保障高温不沸腾。" },
              { icon: PhoneCall, title: "7x24 终身技术指导", desc: "拥有双语专家护航的紧急技术支援小队，提供无延迟的长途排错、图纸指引与跨国连线辅导。" },
              { icon: Globe, title: "跨洋海运零盲区清关", desc: "凭借深耕非洲、南美的高能航运合作伙伴，打磨出包税清关、滚装直航一体化的极简提货路线。" }
            ].map((feature, i) => (
              <div key={i} className="flex flex-col items-center text-center p-8 bg-gray-50 border border-gray-100 hover:border-black transition-colors duration-500 shadow-sm hover:shadow-xl group">
          ...
          <div className="text-center">
             <button className="h-16 px-12 bg-[#111111] text-white text-[13px] font-bold tracking-[0.2em] uppercase hover:bg-[#D4AF37] hover:text-black transition-all shadow-xl inline-flex items-center gap-4">
                 探索完整增值出海体系
                 <ArrowRight size={16} />
             </button>
          </div>
      ...
      <section className="w-full py-32 bg-[#FAFAFA] border-t border-gray-100">
        <div className="max-w-[1440px] mx-auto px-8">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 gap-8">
            <div className="flex flex-col shrink-0">
              <h2 className="text-5xl md:text-6xl font-black tracking-tighter text-[#111111] uppercase">交机实录与动态</h2>
            </div>
            <div className="max-w-xl border-l-4 border-[#D4AF37] pl-6 hidden lg:block">
              <p className="text-gray-500 text-sm leading-relaxed font-medium">真实发盘、跨国海运、开箱验收。我们为您展示实时的设备全球周转录像与物流快讯，亲眼见证我们的端到端跨国履约与重装交付能力。</p>
            </div>
          </div>
          ...
          <div className="relative w-full group/news">
            <div ref={newsScrollRef} className="flex overflow-x-auto gap-8 pb-8 snap-x snap-mandatory [&::-webkit-scrollbar]:hidden" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
              ...
              {[
                 {tag: "装船实况", date: "Oct 24, 2026", country: "🇳🇬 拉各斯，尼日利亚", title: "三台 CAT 336 型重装挖掘机完成翻新，装板启航发往西非新金矿区。", img: "/hero.png"},
                 {tag: "交机签收", date: "Oct 15, 2026", country: "🇦🇪 迪拜，阿联酋", title: "无惧阿布扎比港口极端高温，我们的 Volvo 三机组成功验收并投运。", img: "/loader.png"},
                 {tag: "发车纪实", date: "Oct 02, 2026", country: "🇨🇱 圣地亚哥，智利", title: "南美首单！两台小松 D155 推土机清关落地，即将征战安第斯山脉。", img: "/hero.png"},
                 {tag: "开箱验车", date: "Sep 18, 2026", country: "🇧🇷 圣保罗，巴西", title: "批量沃尔沃装载机抵达圣保罗，即将分发至南美各大型伐木场。", img: "/loader.png"}
              ].map((news, i) => (
                 <div key={i} className="group cursor-pointer shrink-0 w-[82vw] sm:w-[420px] snap-center">
                    <div className="relative w-full aspect-[4/3] rounded-sm overflow-hidden mb-6 border border-gray-200">
                      ...
                      <div className="absolute bottom-4 left-4 bg-white/95 backdrop-blur-md px-4 py-2 text-[11px] font-black tracking-widest uppercase flex flex-col gap-1 shadow-lg border border-gray-100">
                         ...
                         <span className="text-[#111111]">{news.country}</span>
                      </div>
                    </div>
      ...
      <section className="relative w-full py-32 bg-white overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto px-8 relative z-10">
          <div className="bg-[#111111] p-10 md:p-20 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center shadow-2xl rounded-sm">
            <div>
               <h2 className="text-3xl md:text-4xl xl:text-5xl font-black text-white mb-6 leading-tight whitespace-nowrap overflow-hidden">
                 未找到心仪的 <span className="text-[#D4AF37]">特定机型？</span>
               </h2>
               <p className="text-gray-400 mb-10 leading-relaxed max-w-md">提供您的工况需求和采买预算，我们的海外专属采购代表将在 12 小时内为您在全球自有仓储网络中匹配最佳的替代品方案。</p>
               <div className="flex flex-col sm:flex-row gap-8 pt-8 border-t border-gray-800">
                  <div className="flex gap-4">
                     ...
                     <div>
                        <p className="text-gray-500 text-[10px] font-bold uppercase tracking-widest mb-1">专属直联</p>
                        <p className="text-white font-bold tracking-wider">+86 (400) 123-4567</p>
                     </div>
                  </div>
                  <div className="flex gap-4">
                     <div className="w-12 h-12 rounded-full border border-gray-700 flex items-center justify-center flex-shrink-0">
                     ...
                     <div>
                        <p className="text-gray-500 text-[10px] font-bold uppercase tracking-widest mb-1">总部寻址</p>
                        <p className="text-white font-bold tracking-wider">中国，上海</p>
                     </div>
                  </div>
               </div>
            </div>
            
            <form className="space-y-6 bg-white p-8 md:p-12 shadow-lg" onSubmit={handleSubmit}>
               <input
                 type="text"
                 name="website"
                 autoComplete="off"
                 ...
                 aria-hidden="true"
               />
               <h3 className="text-2xl font-black text-[#111111] mb-8">即刻获取定制报价</h3>
               <div className="grid grid-cols-1 gap-6">
                 {/* 精简为最高转化的纯正 3 字段收网节点 */}
                 <div className="border-b border-gray-300 focus-within:border-[#111111] transition-colors group">
                   <input name="name" required type="text" placeholder="您的称呼 *" className="w-full py-3 text-sm focus:outline-none bg-transparent font-medium group-focus-within:placeholder:text-gray-400" />
                 </div>
                 <div className="border-b border-gray-300 focus-within:border-[#111111] transition-colors group">
                   <input name="contact" required type="text" placeholder="WhatsApp / 邮箱 *" className="w-full py-3 text-sm focus:outline-none bg-transparent font-medium group-focus-within:placeholder:text-gray-400" />
                 </div>
                 <div className="border-b border-gray-300 focus-within:border-[#111111] transition-colors group pt-2">
                   <textarea name="message" required placeholder="意向机械与特定工况需求 (必填)" rows={3} className="w-full py-3 text-sm focus:outline-none bg-transparent resize-none font-medium group-focus-within:placeholder:text-gray-400"></textarea>
                 </div>
               </div>
               {submitMessage ? (
               ...
               <div className="flex flex-col sm:flex-row items-center gap-4 mt-8">
                 ...
                 >
                   {submitState === "loading" ? "提交中..." : "获取专属定制报价"} <Send size={16} />
                 </button>
               </div>
            </form>
          </div>
