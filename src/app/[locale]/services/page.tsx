...
export default function ServicesPage() {
  ...
  const { get: c } = usePageContent('services');
          ...
          <div className="bg-[#1A1A1A] p-10 md:p-14 shadow-[0_30px_60px_rgba(0,0,0,0.5)] border border-white/10 mx-auto rounded-[32px] relative overflow-hidden">
             ...
             <form onSubmit={handleSubmit} className="flex flex-col gap-6 relative z-10">
                 ...
                 <div className="bg-[#111111] rounded-2xl px-6 py-4 border border-white/5 focus-within:border-[#D4AF37]/40 focus-within:bg-[#000000] transition-all group">
                   ...
                   <textarea name="message" placeholder={c('cta.formPlaceholder', isZh ? "请描述您的意向机械型号与工况需求..." : "Please describe your machinery requirements...")} rows={4} className="w-full py-2 text-sm focus:outline-none bg-transparent resize-none font-medium text-white placeholder:text-gray-600"></textarea>
                 </div>
