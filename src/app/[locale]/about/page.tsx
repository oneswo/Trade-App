      ...
      <section className="relative w-full h-[450px] md:h-[500px] flex items-center justify-center bg-[#111111] overflow-hidden">
         ...
         <div className="relative z-10 flex flex-col items-center px-4 w-full max-w-[1100px] mx-auto text-center mt-4">
            ...
            <div className="flex items-center justify-center gap-3 text-[#D4AF37] text-xs font-bold tracking-[0.2em] uppercase mb-8 border border-[#D4AF37]/20 rounded-full px-5 py-2 bg-[#D4AF37]/5 backdrop-blur-md shadow-lg">
              ...
              {isZh ? '全球工程机械发运枢纽' : 'GLOBAL MACHINERY HUB'}
            </div>
            ...
            <h1 className="text-5xl md:text-[80px] font-black text-white tracking-[0.1em] mb-10 leading-none whitespace-nowrap drop-shadow-2xl">
              {isZh ? '扎根上海，' : 'ROOTED IN SH, '}<span className="text-[#D4AF37]">{isZh ? '驱动全球。' : 'DRIVE GLOBAL.'}</span>
            </h1>
            ...
            <div className="w-full flex items-center justify-center min-h-[60px] md:min-h-[80px]">
              {isZh ? (
                 <div className="w-full text-gray-400 text-lg md:text-[21px] font-medium flex justify-between items-center opacity-90 max-w-[900px]">
                    {"重塑二手工程机械出海领域的绝对信任标杆，严苛重金整备与出境质检，确保全球买家拿到顶尖实机。".split('').map((char, index) => (
                      <span key={index}>{char}</span>
                    ))}
                 </div>
              ) : (
                 <p className="text-gray-400 text-lg md:text-xl font-medium leading-relaxed max-w-3xl text-center mx-auto">
                   Reshaping the absolute trust benchmark in the global used heavy equipment supply chain, ensuring every buyer receives top-tier machines.
                 </p>
              )}
            </div>
          ...
          <div className="flex flex-col gap-32">
            ...
            <div className="relative flex flex-col md:flex-row items-center justify-between group">
              ...
              <div className="w-full md:w-5/12 text-left mt-16 md:mt-0 relative md:pl-16">
                ...
                <p className="text-gray-500 leading-relaxed font-medium text-[15px] mb-6">
                  自2003年起，我们深度扎根于具有全球航运统治力的上海港腹地。打造了拥有逾 2000平米 的现代化重装整备急库区，绝不倒买倒卖，坚持全仓纯实体现车。
                </p>
                <p className="text-gray-500 leading-relaxed font-medium text-[15px]">
                  基地内置独立无尘液压车间与动力测试线。我们斥资汇聚业内尖端检测仪与退役资深工程师，确保所有经我们出海的卡特彼勒、小松、日立等重卡，拥有硬核的原厂级运转能力。
                </p>
                ...
                <ul className="mt-10 space-y-5">
                  <div className="flex items-center gap-4 bg-white p-4 rounded-2xl shadow-sm border border-gray-100 transition-colors hover:border-[#D4AF37]/30">
                     ...
                     <span className="text-[#111111] font-black text-[15px]">全驱自营机械整备流水线</span>
                  </div>
                  <div className="flex items-center gap-4 bg-white p-4 rounded-2xl shadow-sm border border-gray-100 transition-colors hover:border-[#D4AF37]/30">
                     <div className="w-10 h-10 rounded-full bg-[#111111] flex items-center justify-center shrink-0">
                        <CheckCircle2 className="text-[#D4AF37]" size={18} />
                     </div>
                     <span className="text-[#111111] font-black text-[15px]">深链大干线专属海运特权</span>
                  </div>
                </ul>
              </div>
            </div>
            ...
            <div className="relative flex flex-col md:flex-row-reverse items-center justify-between group">
              ...
              <div className="w-full md:w-5/12 text-left mt-16 md:mt-0 relative md:pr-16">
                ...
                <p className="text-gray-500 leading-relaxed font-medium text-[15px] mb-6">
                  重载机械漂洋过海不是终点，矿山实操才是！我们的海外业务不仅仅是“卖单机器”，更是全生命周期的工业护航。
                </p>
                <p className="text-gray-500 leading-relaxed font-medium text-[15px]">
                  至今，我们高密度地将成套编队级工程机械成功投送至印尼镍矿、秘鲁铜矿区、以及肯尼亚基建一线。以严苛的拒售翻新组装机的红线铁律，建立起跨国老客的绝对信任壁垒。
                </p>
                ...
                <div className="mt-10 grid grid-cols-2 gap-4">
                  <div className="bg-white rounded-2xl border border-gray-200 p-6 hover:shadow-[0_10px_30px_rgba(0,0,0,0.05)] transition-all group/card overflow-hidden relative">
                    ...
                    <h4 className="text-[#111111] font-black tracking-widest text-[13px] mb-3 uppercase relative z-10">{isZh ? '绝不妥协的品控' : 'Integrity & Mutual Benefit'}</h4>
                    <p className="text-gray-500 text-xs font-medium leading-relaxed relative z-10">{isZh ? '一票否决事故框架与火烧水淹，从物理源头捍卫商誉。' : 'We never trade in accident-damaged or rebuilt machines — our foundation is built on long-term partnerships worldwide.'}</p>
                  </div>
                  <div className="bg-[#111111] rounded-2xl border border-gray-800 p-6 hover:shadow-[0_10px_30px_rgba(212,175,55,0.15)] transition-all group/card overflow-hidden relative">
                    ...
                    <h4 className="text-[#D4AF37] font-black tracking-widest text-[13px] mb-3 uppercase relative z-10">{isZh ? '云端穿洲排障' : 'Service First'}</h4>
                    <p className="text-gray-400 text-xs font-medium leading-relaxed relative z-10">{isZh ? '首席技师无视时区差，跨洋视频连线硬核拆解指导。' : 'Dedicated engineers provide seamless maintenance support across all time zones.'}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-[1440px] w-full px-8 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 divide-y md:divide-y-0 md:divide-x divide-white/10 text-center">
            ...
            <div className="flex flex-col items-center justify-center pt-8 md:pt-0">
              <span className="text-5xl md:text-6xl font-black text-white mb-3">20<span className="text-[#D4AF37]">+</span></span>
              <span className="text-gray-400 text-sm font-black tracking-widest uppercase">{isZh ? '年出海行业深耕' : 'Years in the Industry'}</span>
            </div>
            
            <div className="flex flex-col items-center justify-center pt-8 md:pt-0">
              <span className="text-5xl md:text-6xl font-black text-white mb-3">30<span className="text-[#D4AF37]">+</span></span>
              <span className="text-gray-400 text-sm font-black tracking-widest uppercase">{isZh ? '支特派抢修梯队' : 'Field Engineers Deployed'}</span>
            </div>

            <div className="flex flex-col items-center justify-center pt-8 md:pt-0">
              <span className="text-5xl md:text-6xl font-black text-white mb-3">50<span className="text-[#D4AF37]">+</span></span>
              <span className="text-gray-400 text-sm font-black tracking-widest uppercase">{isZh ? '个矿建出海国家' : 'Countries Reached'}</span>
            </div>

            <div className="flex flex-col items-center justify-center pt-8 md:pt-0">
              <span className="text-5xl md:text-6xl font-black text-white mb-3">3000<span className="text-[#D4AF37]">+</span></span>
              <span className="text-gray-400 text-sm font-black tracking-widest uppercase">{isZh ? '台实体现车交付' : 'Machines Safely Delivered'}</span>
            </div>
        ...
        <div className="max-w-[1440px] mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-[#FAFAFA] p-6 rounded-3xl border border-gray-100 hover:shadow-[0_20px_40px_rgba(0,0,0,0.06)] hover:border-[#D4AF37]/30 hover:-translate-y-2 transition-all duration-500 overflow-hidden relative group">
              ...
              <div>
                <h4 className="text-[#111111] font-black text-lg tracking-wide mb-1">重工溯源认证</h4>
                <p className="text-gray-500 text-xs font-bold uppercase tracking-wider">VERIFIED SUPPLIER</p>
              </div>
            </div>
            ...
            <div className="bg-[#FAFAFA] p-6 rounded-3xl border border-gray-100 hover:shadow-[0_20px_40px_rgba(0,0,0,0.06)] hover:border-[#D4AF37]/30 hover:-translate-y-2 transition-all duration-500 overflow-hidden relative group">
              ...
              <div>
                <h4 className="text-[#111111] font-black text-lg tracking-wide mb-1">欧盟通行准入</h4>
                <p className="text-gray-500 text-xs font-bold uppercase tracking-wider">CE CONFORMITY</p>
              </div>
            </div>
            ...
            <div className="bg-[#FAFAFA] p-6 rounded-3xl border border-gray-100 hover:shadow-[0_20px_40px_rgba(0,0,0,0.06)] hover:border-[#D4AF37]/30 hover:-translate-y-2 transition-all duration-500 overflow-hidden relative group">
              ...
              <div>
                <h4 className="text-[#111111] font-black text-lg tracking-wide mb-1">国际质控标准</h4>
                <p className="text-gray-500 text-xs font-bold uppercase tracking-wider">ISO 9001:2015</p>
              </div>
            </div>
            ...
            <div className="bg-[#FAFAFA] p-6 rounded-3xl border border-gray-100 hover:shadow-[0_20px_40px_rgba(0,0,0,0.06)] hover:border-[#D4AF37]/30 hover:-translate-y-2 transition-all duration-500 overflow-hidden relative group">
              ...
              <div>
                <h4 className="text-[#111111] font-black text-lg tracking-wide mb-1">第三方驻场终检</h4>
                <p className="text-gray-500 text-xs font-bold uppercase tracking-wider">SGS INSPECTION</p>
              </div>
            </div>
          </div>
        </div>
