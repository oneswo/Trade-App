              ...
              <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
                 ...
                 <div className="flex flex-col sm:flex-row items-center gap-4 mt-6">
                   ...
                   <button
                     ...
                     className="flex-1 w-full h-14 rounded-full bg-[#111111] text-white text-[13px] font-bold tracking-[0.2em] uppercase hover:bg-[#D4AF37] hover:text-black transition-colors flex items-center justify-center gap-3 shadow-[0_10px_30px_rgba(0,0,0,0.15)] disabled:opacity-60 disabled:cursor-not-allowed"
                   >
